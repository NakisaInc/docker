...
case $NAK_INSTALLATION_TYPE in
  "MicroHTTP")            NAK_MEMORY_MIN_HANELLY=400m;  NAK_MEMORY_MAX_HANELLY=400m;  NAK_MEMORY_ES=400m;  NAK_SECURED_COOKIES=false;;
  "MicroHTTPS")           NAK_MEMORY_MIN_HANELLY=400m;  NAK_MEMORY_MAX_HANELLY=400m;  NAK_MEMORY_ES=400m;  NAK_SECURED_COOKIES=true;;
  "MiniHTTP")             NAK_MEMORY_MIN_HANELLY=800m;  NAK_MEMORY_MAX_HANELLY=800m;  NAK_MEMORY_ES=800m;  NAK_SECURED_COOKIES=false;;
  "MiniHTTPS")            NAK_MEMORY_MIN_HANELLY=800m;  NAK_MEMORY_MAX_HANELLY=800m;  NAK_MEMORY_ES=800m;  NAK_SECURED_COOKIES=true;;
  "DemoHTTP")             NAK_MEMORY_MIN_HANELLY=1500m; NAK_MEMORY_MAX_HANELLY=1500m; NAK_MEMORY_ES=1500m; NAK_SECURED_COOKIES=false;;
  "DemoHTTPS")            NAK_MEMORY_MIN_HANELLY=1500m; NAK_MEMORY_MAX_HANELLY=1500m; NAK_MEMORY_ES=1500m; NAK_SECURED_COOKIES=true;;
  "Training")             NAK_MEMORY_MIN_HANELLY=3000m; NAK_MEMORY_MAX_HANELLY=3000m; NAK_MEMORY_ES=3500m; NAK_SECURED_COOKIES=false;;
  "XSmallUnmonitored")    NAK_MEMORY_MIN_HANELLY=2500m; NAK_MEMORY_MAX_HANELLY=2500m; NAK_MEMORY_ES=3000m; NAK_SECURED_COOKIES=true;;
  "XSmallMonitored")      NAK_MEMORY_MIN_HANELLY=3000m; NAK_MEMORY_MAX_HANELLY=3000m; NAK_MEMORY_ES=2500m; NAK_SECURED_COOKIES=true;;
  "Small")                NAK_MEMORY_MIN_HANELLY=5g;    NAK_MEMORY_MAX_HANELLY=5g;    NAK_MEMORY_ES=5g;    NAK_SECURED_COOKIES=true;;
  "Medium")               NAK_MEMORY_MIN_HANELLY=10g;   NAK_MEMORY_MAX_HANELLY=10g;   NAK_MEMORY_ES=10g;   NAK_SECURED_COOKIES=true;;
  "Large")                NAK_MEMORY_MIN_HANELLY=32g;   NAK_MEMORY_MAX_HANELLY=32g;   NAK_MEMORY_ES=16g;   NAK_SECURED_COOKIES=true;;
  *)                      NAK_MEMORY_MIN_HANELLY=1500m; NAK_MEMORY_MAX_HANELLY=1500m; NAK_MEMORY_ES=1500m; NAK_SECURED_COOKIES=true;;
esac
